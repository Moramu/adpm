...
@section('content')
	    ...
	    <div class="pull-left">
		<h1 class="pageH1">Edit Lighting</h1>
	    </div>
	    <div class="pull-right">
		<a class="btn btn-info createButton" href="{{route('lightings.index') }}">Back</a>
	    </div>
    ...
    {!! Form::model($lighting, ['method' => 'PATCH','route' => ['lightings.update', $lighting],'files'=>'true']) !!}
    <div class="row">
