...
@section('content')
	    ...
	    <div class="pull-left">
		<h1 class="pageH1">Edit Additive</h1>
	    </div>
	    <div class="pull-right">
		<a class="btn btn-info createButton" href="{{route('additives.index') }}">Back</a>
	    </div>
    ...
    {!! Form::model($additive, ['method' => 'PATCH','route' => ['additives.update', $additive],'files'=>'true']) !!}
    <div class="row">
